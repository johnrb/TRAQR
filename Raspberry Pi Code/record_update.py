        ...
        while self.running:
            ...
            if (v_change < -0.10): # adjusted for adc conversion. the *real* change we are looking for is +-0.5V 
                ...
                if (self.sensor_status == "on"):
                    ...
                    self.sensor_status = "off"
                GPIO.output(12,1)  # setting pin 12 high turns the regulator off
                ...
                print ("a voltage increase has indicated that the car has turned on. voltage increase: " + str(abs(v_change)) + "V")
